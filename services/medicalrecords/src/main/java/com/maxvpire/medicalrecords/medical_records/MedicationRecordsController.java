...
public class MedicationRecordsController {
    ...
    @PostMapping()
    public ResponseEntity<String> createMedicationRecord(@Valid @RequestBody MedicationRecordRequest request) {
        return ResponseEntity.ok(medicationRecordsService.create(request));
    }
